...
Public Class MessageExt
    ...
    Property DrawBorder As Boolean
        ...
        End Set
    End Property
    Dim mTextAlign As ContentAlignment
    <Description("文本对齐方式")>
    Public Overloads Property TextAlign As ContentAlignment
        ...
        Set(ByVal value As ContentAlignment)
            If mTextAlign = value Then Return
            mTextAlign = value
            Me.InitializeRectangle()
            Me.Invalidate()
        End Set
    ...
    Private Sub InitializeRectangle()
        ...
        If AutoSize Then
            ControlExt.Common.SetWindowPos(mHandle, Me.Location.X, Me.Location.Y, CInt(text_reality_mrect.Width + 2), CInt(text_reality_mrect.Height + 2))
        Else
